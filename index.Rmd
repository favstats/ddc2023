...
### Is Political Microtargeting Destroying Democracy?
...
#### 1. Inadequate or no data (on actual targeting strategies)
...
### 1. Inadequate or hard-to-access data
...
+ Interviews *(López Ortega, 2022; Silva et al., 2020)*
...
+ data annotated & enhanced using the *Party Facts database* (Döring & Regel 2019)
  ...
  + we hand-coded over 9k advertisers and 900 parties (100 top advertisers + 50 random sample per election)
  
+ Multi-source matching 

   + based on dictionary
   + open databases like Wikipedia, Google data, also Who Targets Me
